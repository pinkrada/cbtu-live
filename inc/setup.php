	...
	function understrap_setup() {
		...
		register_nav_menus(
			array(
				...
				'footer_bottom' => __( 'Footer Bottom Menu', 'understrap' )
			)
		);
...
if ( ! function_exists( 'understrap_all_excerpts_get_more_link' ) ) {
	...
	function understrap_all_excerpts_get_more_link( $post_excerpt ) {
		if ( ! is_admin() ) {
			$post_excerpt = $post_excerpt . ' [...]<p><a class="btn btn-primary" href="' . esc_url( get_permalink( get_the_ID() ) ) . '">' . __(
				'Learn More &#43;',
				'cbtu'
			) . '</a></p>';
		}
...
add_filter('acf/upload_prefilter/key=field_614d877528c30', 'gist_acf_upload_dir_prefilter', 10, 3);

// Custom upload directory
function gist_acf_upload_dir($param) {

    // Set to whatever directory you want the ACF file field to upload to
    $custom_dir = '/uploads/members_directory';
